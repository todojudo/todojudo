...
<link rel="stylesheet" href="<?php echo $tmpTools->baseurl(); ?>templates/<?php echo $this->template; ?>/css/template.css" type="text/css" />

<script language="javascript" type="text/javascript" src="<?php echo $tmpTools->baseurl(); ?>templates/<?php echo $this->template; ?>/js/ja.script.js"></script>
...
<script language="javascript" type="text/javascript" src="<?php echo $tmpTools->baseurl(); ?>templates/<?php echo $this->template; ?>/js/ja.rightcol.js"></script>
<?php endif; ?>

<?php  if($this->direction == 'rtl') : ?>
<link rel="stylesheet" href="<?php echo $tmpTools->baseurl(); ?>templates/<?php echo $this->template; ?>/css/template_rtl.css" type="text/css" />
<?php else : ?>
<link rel="stylesheet" href="<?php echo $tmpTools->baseurl(); ?>templates/<?php echo $this->template; ?>/css/menu.css" type="text/css" />
<?php endif; ?>

<?php if ($this->countModules('hornav')): ?>
<?php if ($tmpTools->getParam('horNavType') == 'css'): ?>
<link rel="stylesheet" href="<?php echo $tmpTools->baseurl(); ?>templates/<?php echo $this->template; ?>/css/ja-sosdmenu.css" type="text/css" />
<script language="javascript" type="text/javascript" src="<?php echo $tmpTools->baseurl(); ?>templates/<?php echo $this->template; ?>/js/ja.cssmenu.js"></script>
<?php else: ?>
<link rel="stylesheet" href="<?php echo $tmpTools->baseurl(); ?>templates/<?php echo $this->template; ?>/css/ja-sosdmenu.css" type="text/css" />
<script language="javascript" type="text/javascript" src="<?php echo $tmpTools->baseurl(); ?>templates/<?php echo $this->template; ?>/js/ja.moomenu.js"></script>
<?php endif; ?>
<?php endif; ?>

<?php if ($tmpTools->getParam('theme_header') && $tmpTools->getParam('theme_header')!='-1') : ?>
<link rel="stylesheet" href="<?php echo $tmpTools->baseurl(); ?>templates/<?php echo $this->template; ?>/styles/header/<?php echo $tmpTools->getParam('theme_header'); ?>/style.css" type="text/css" />
<?php endif; ?>
<?php if ($tmpTools->getParam('theme_background') && $tmpTools->getParam('theme_background')!='-1') : ?>
<link rel="stylesheet" href="<?php echo $tmpTools->baseurl(); ?>templates/<?php echo $this->template; ?>/styles/background/<?php echo $tmpTools->getParam('theme_background'); ?>/style.css" type="text/css" />
<?php endif; ?>
<?php if ($tmpTools->getParam('theme_elements') && $tmpTools->getParam('theme_elements')!='-1') : ?>
<link rel="stylesheet" href="<?php echo $tmpTools->baseurl(); ?>templates/<?php echo $this->template; ?>/styles/elements/<?php echo $tmpTools->getParam('theme_elements'); ?>/style.css" type="text/css" />
<?php endif; ?>
...
<div id="ja-containerwrap2">
	...
	<div id="ja-container2" class="clearfix">
		...
		<div id="ja-content">
			...
			<?php endif ; ?>	
			<?php if($this->countModules('superiorprincipal')) : ?>
			<div id="sup-pal">
				<jdoc:include type="modules" name="superiorprincipal" />	
			</div>
			<?php endif; ?>            
...
<div id="ja-footer" class="clearfix">
    ...
    <a href="http://jigsaw.w3.org/css-validator/check/referer" target="_blank" title="<?php echo JText::_("CSS Validity");?>" style="text-decoration: none;">
		<img src="<?php echo $tmpTools->baseurl(); ?>templates/<?php echo $this->template; ?>/images/but-css.gif" border="none" alt="<?php echo JText::_("CSS Validity");?>" />
		</a>
...
var pageTracker = _gat._getTracker("UA-7060500-1");
